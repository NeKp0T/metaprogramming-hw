...
;;; Format: (code lineNumber leftList rightList)
...
(define (tm-int-steps code lineNumber leftList rightList)
    (if (>= lineNumber (length code))
        ...
        (match (tm-int-step code lineNumber leftList rightList)
            [`(,code1 ,lineNumber1 ,leftList1 ,rightList1) (tm-int-steps code1 lineNumber1 leftList1 rightList1)] ; there is a way to do this without pattern-matching, but it's weird
        )))
...
(define tm-result (tm-int tm-example '(1) '(1 1 1 0 1 1 1)))  ; 11111 111

(define tm-result2 (tm-int tm-example2 '(1) '(1 1 1 0 1 1 1))) ; 111101111 ()